[EN]
Ren'Py Translation Key Checker
...
2. Distribution of diff information:
...
When a file is found to be unchanged, choose whether to copy the translated file to the new _replaced folder, or simply continue with the next one.
...
Cuando se encuentre que un archivo no ha tenido cambios, elige si copiar el archivo traducido a la nueva carpeta _replaced, o simplemente continuar con el siguiente.
